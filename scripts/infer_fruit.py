#!/usr/bin/env python3
"""对单张或多张图片做水果分类推理（EfficientNet-Lite0 / timm tf_efficientnet_lite0）。"""
...
DEFAULT_WEIGHTS = REPO_ROOT / "models" / "efficientnet_lite0_fruit_cls_best.pt"
...
def main() -> int:
    p = argparse.ArgumentParser(description="EfficientNet-Lite0 水果分类推理")
